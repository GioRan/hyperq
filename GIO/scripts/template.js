window.template = {
		...
		var sidebar = $("<ul id='slide-out' class='side-nav'>" +
							"<li><div class='userView'>" +
								"<div class='background'>" +
									"<img class='override-sidebar-background-img' src='http://www.hyperq.com/GIO/images/sidebar-img.jpg'>" +
								"</div>" +
								"<img class='circle' src='http://www.hyperq.com/GIO/images/sidebar-profile-img.png'>" +
	...
	userInfoTemplate: function(){
		...
		if($(".indexMain").length == 0){
			$(".nav-wrapper").html("<a href='http://www.hyperq.com/GIO/index' class='left brand-logo button-collapse override-navbar-button-collapse'><i class='material-icons'>arrow_back</i></a>");
